    ...
    render(){return(
        <div id="Contact">
            ...
            <div className="contact-card">
                ...
                <span className="contact-title">GET IN TOUCH</span><br/>
                <span className="contact-subTitle">I'd love to hear your thoughts!</span>
                ...
                <div className="contact-details">
                    ...
                    <div className="contact-item">
                        ...
                        <a href="mailto:hello@shanzid.com"><span className="contact-text">hello@shanzid.com</span></a>
                    </div>
                </div>
                <div className="line-break-m" />
                <Socials />
